...
- **Télécommande mobile (admin)** : piloter la projection **depuis son téléphone** (◀ ▶, **écran noir**, vignette « suivante ») via un **relais serveur léger** (SSE + POST, en mémoire) et un **code d'appairage**. Le téléphone pilote la régie, qui mène l'écran public. Pratique pour se déplacer pendant le spectacle sans rester derrière le PC.
